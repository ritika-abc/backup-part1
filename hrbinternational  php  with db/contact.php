                    ...
                    <div class="d-flex flex-column justify-content-center bg-primary h-100 p-5">
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Our Office</h4>
                                <p class="m-0 text-white">31 BHATPORE GIDC, OPPOSITE ONGC COMPANY, BHATPORE, HAZIRA, Surat , Gujrat.</p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4 mb-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Email Us</h4>
                                <p class="m-0 text-white">+91-97124-44244</p>
                            </div>
                        </div>
                        <div class="d-inline-flex border border-secondary p-4">
                            ...
                            <div class="d-flex flex-column">
                                <h4>Call Us</h4>
                                <p class="m-0 text-white">0091 9925235654/ 0091 9712444244</p>
                            </div>
                        </div>
                    </div>
                </div>
