...
<head>
    ...
    <link rel="canonical" href="https://bkainternational.com/single-blog.php?slug=<?php echo $slug ?>">
    <!-- Favicon -->
...
<head>
   ...
   <meta name="keywords" content="Banana Powder Exporters in Vietnam , Banana Powder Exporters in Philippines , Banana Powder Exporters in Belgium " / >
    <meta name="description" content="Banana Powder is processed from the fresh bananas. Banana Powder Exporters in Vietnam is typically the best quality powder that is found in many sectors light. " / >
...
<body>
                ...
                <div class="container">
                    ...
                    <div class="webMenu d-none d-lg-block position-relative">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand position-relative" href="index.html"> <img src="logo.png" height="170px" width="170px" alt="BKA International
                                "></a>
  ...
  <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                          <li><a class="dropdown-item" href="banana-powder.html">Banana Powder</a></li>
                                          <li><a class="dropdown-item" href="spinach-powder.html">Spinach Powder</a></li>
                                           
                                          <li><a class="dropdown-item" href="beetroot-powder.html">Beetroot Powder</a></li>
                                          <li><a class="dropdown-item" href="moringa-powder.html">Moringa Powder</a></li>
                                        </ul>
                                      </li>
                                </ul>
                            </div>
                    ...
                    <div class="mobileMenu d-block d-lg-none">
                        <nav class="navbar navbar-expand-lg navbar-light">
                            <a class="navbar-brand position-relative" href="index.html"> <img src="logo.png" height="150px" width="150px" alt="BKA International
                                "></a>
                            <button class="navbar-toggler" style="background:white" type="button" data-bs-toggle="offcanvas"
                                data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling"
                                aria-expanded="false" aria-label="Toggle navigation">
                                <span class="navbar-toggler-icon"></span>
                            </button>
                            <div class="offcanvas offcanvas-start show text-bg-dark" style="background:black" data-bs-scroll="true" data-bs-backdrop="false"
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="footer_inner_choose_content">
                                        ...
                                        <div class="footer_inner_choose_desc pt-2">
                                            <p>Welcome to BKA International, your trusted partner in premium fruit and vegetable powders. We are passionate about harnessing the natural goodness of fruits and vegetables, transforming them into convenient,..</p>
                                        </div>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="footer_inner_cotc_content">
                                        ...
                                        <div class="footer_inner_ctc_info pt-2 text-white">
                                            <p>Address: <font>Second floor, 415A Kambal Vala Bhag, Muzaffarnagar Up India 251001</font>
                                            </p>
                                    ...
                                    <div class="product_layout_1 overflow-hidden position-relative">
                                        <div class="product_layout_content bg-white position-relative">
                                            <div class="product_image_wrap">
                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                    href="product-detail.html">
                                                    <img src="assets/images/product/product10.png"
                                                        alt="no image">
                                                </a>
                                                <ul class="product_badge_group ul_li_block">
                                                    <li><span
                                    ...
                                    <div class="product_layout_1 overflow-hidden position-relative">
                                        <div class="product_layout_content bg-white position-relative">
                                            <div class="product_image_wrap">
                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                    href="product-detail.html">
                                                    <img src="assets/images/product/product11.png"
                                                        alt="no image">
                                                </a>
                                                <ul class="product_badge_group ul_li_block">
                                                    <li><span
                                    ...
                                    <div class="product_layout_1 overflow-hidden position-relative">
                                        <div class="product_layout_content bg-white position-relative">
                                            <div class="product_image_wrap">
                                                <a class="product_image d-flex justify-content-center align-items-center"
                                                    href="product-detail.html">
                                                    <img src="assets/images/product/product12.png"
                                                        alt="no image">
                                                </a>
                                                <ul class="product_badge_group ul_li_block">
                                                    <li><span
