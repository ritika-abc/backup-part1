                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <h1 class="display-6 text-white animated slideInRight mb-3"> "Precision, Compassion,
                                        Healing: Where Every Incision Tells a Story of Hope."</h1>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <h1 class="display-6 text-white animated slideInLeft mb-3">Empowering surgeons with
                                        cutting-edge precision for life-saving excellence.</h1>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <a href="about.php" class="btn btn-primary px-3 text-capitalize">read more</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-0 feature-row">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        ...
                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur tellus augue.
                        </p>
                    </div>
                </div>
        ...
        <div class="container pt-5">
            ...
            <div class="container" style="margin-top: 3rem; ">
                <div class="row   ">
                    ...
                    ?>
<a href="product.php" class="btn btn-primary w-25 m-auto my-5 py-3">More Products..</a>
                    <!-- <div class="col-12 col-lg-4 my-3">
                        <div class="card_box border shadow-lg  bg-white">
                            <div class="img_animation border border-3 border-dark p-2">
                                <img src="img/product/2.jpg" height="auto" width="100%" alt="">
                            </div>
                            <div class="image_box mt-2 px-3 py-4">
                                <h3 class="text-center text-capitalize h5 py-3"> X-ray Detectable Gauze swabs</h3>
                                <p style="text-align: justify;">Introducing our X-ray Detectable Gauze Swabs, a
                                    revolutionary solution for surgical precision and safety....</p>
                                <a href="" class="btn text-capitalize btn-primary  " data-bs-toggle="modal" data-bs-target="#exampleModal">enquiry now</a>
                                <a href="" class="btn text-capitalize btn-outline-primary  mx-2 ">view more</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 my-3">
                        <div class="card_box border shadow-lg  bg-white">
                            <div class="img_animation border border-3 border-dark p-2">
                                <img src="img/product/3new.jpg" height="auto" width="100%" alt="">
                            </div>
                            <div class="image_box mt-2 px-3 py-4">
                                <h3 class="text-center text-capitalize h5 py-3"> Abdominal gauze pad (laparotomy sponge)
                                </h3>
                                <p style="text-align: justify;">Our Gauze Swabs are meticulously crafted to meet the
                                    stringent demands of surgical ...</p>
                                <a href="" class="btn text-capitalize btn-primary  " data-bs-toggle="modal" data-bs-target="#exampleModal">enquiry now</a>
                                <a href="" class="btn text-capitalize btn-outline-primary  mx-2 ">view more</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 my-3">
                        <div class="card_box border shadow-lg  bg-white">
                            <div class="img_animation border border-3 border-dark p-2">
                                <img src="img/product/4.jpg" height="auto" width="100%" alt="">
                            </div>
                            <div class="image_box mt-2 px-3 py-4">
                                <h3 class="text-center text-capitalize h5 py-3"> Gauze combine dressing pad</h3>
                                <p style="text-align: justify;">Introducing our Gauze Combine Dressing Pad, a versatile
                                    and essential component in wound care management. Meticulously ..</p>
                                <a href="" class="btn text-capitalize btn-primary  " data-bs-toggle="modal" data-bs-target="#exampleModal">enquiry now</a>
                                <a href="" class="btn text-capitalize btn-outline-primary  mx-2 ">view more</a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 my-3">
                        <div class="card_box border shadow-lg  bg-white">
                            <div class="img_animation border border-3 border-dark p-2">
                                <img src="img/product/5.jpg" height="auto" width="100%" alt="">
                            </div>
                            <div class="image_box mt-2 px-3 py-4">
                                <h3 class="text-center text-capitalize h5 py-3"> Gamjee roll (dressing roll)</h3>
                                <p style="text-align: justify;">Introducing our Gamjee Roll, a versatile and
                                    indispensable dressing roll for wound care management. Expertly crafted to meet
                                    the...</p>
                                <a href="" class="btn text-capitalize btn-primary  " data-bs-toggle="modal" data-bs-target="#exampleModal">enquiry now</a>
                                <a href="" class="btn text-capitalize btn-outline-primary  mx-2 ">view more</a>
                            </div>
                    ...
                    <div class="col-12 col-lg-4 my-3">
                        <div class="card_box border shadow-lg  bg-white">
                            <div class="img_animation border border-3 border-dark p-2">
                                <img src="img/product/6.jpg" class="" height="auto" width="100%" alt="">
                            </div>
                            <div class="image_box mt-2 px-3 py-4">
                                <h3 class="text-center text-capitalize h5 py-3"> Dressing Kit</h3>
                                <p style="text-align: justify;">ntroducing our comprehensive Dressing Kit, a complete
                                    solution for wound care needs in medical settings. Carefully curated with ...</p>
                                <a href="" class="btn text-capitalize btn-primary  " data-bs-toggle="modal" data-bs-target="#exampleModal">enquiry now</a>
                                <a href="" class="btn text-capitalize btn-outline-primary  mx-2 ">view more</a>
                            </div>
                        </div>
        ...
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                    <div class="ceo">
                        <img class=" " src="img/ceo 1.png" height="auto" width="100%" alt="">

                    </div>
                </div>
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-6 mb-3">M.BOOPATHY</h1>
                    <p class="mb-1">CEO (GLOBAL SURGICARE)</p>
                    <p class="mb-5"> 238b/15 South Street,Chatrapatti Factory: 294-H, Arumugathevar Nagar,Ayyanapuram,Ch
                    </p>
                    <!-- <h3 class="mb-3">Biography</h3> -->
                    <table class="table  text-dark  mb-3 w-75">
                        <tr>
                            <td>Qualification : </td>
                            <td>B.E</td>
                        </tr>
                        ...
                        <tr>
                            <td>Email Id : </td>
                            <td><small> globalsurgicareindia@gmail.com</small></td>
                        </tr>
                    </table>
